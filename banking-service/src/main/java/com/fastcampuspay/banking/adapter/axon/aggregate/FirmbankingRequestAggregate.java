...
public class FirmbankingRequestAggregate {
	...
	public FirmbankingRequestAggregate(CreateFirmbankingRequestCommand command) {
		...
		apply(new FirmbankingRequestCreatedEvent(command.getFromBankName(), command.getFromBankAccountNumber(), command.getToBankName(),
	...
	@CommandHandler
	public FirmbankingRequestAggregate(
		RequestFirmbankingCommand command, RequestFirmbankingPort firmbankingPort,
	...
	@CommandHandler
	public FirmbankingRequestAggregate(
		@NotNull com.fastcampuspay.common.event.RollbackFirmbankingRequestCommand command, RequestFirmbankingPort firmbankingPort,
		RequestExternalFirmbankingPort externalFirmbankingPort
	) {
