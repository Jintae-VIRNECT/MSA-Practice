...
import com.fastcampuspay.banking.adapter.out.persistence.FirmbankingRequestConvertor;
...
public class RequestFirmbankingService implements RequestFirmbankingUseCase, UpdateFirmbankingUseCase {
	...
	public FirmbankingRequest requestFirmbanking(RequestFirmbankingCommand command) {
		...
		return FirmbankingRequestConvertor.entityToDomain(requestFirmbankingPort.modifyFirmbankingRequest(requestedEntity), randomUUID);
	}
